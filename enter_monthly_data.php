...
<title>Enter Monthly Data</title>
</head>
...
<table width="50%" border="0" cellspacing="1" cellpadding="1" align="center" style="margin-top:10px; margin-bottom:20px; background-color:#FFF">
  <tr bgcolor="#990000" >
    <td height="52" colspan="3"><div align="center" class="tabletitle">Select the month to enter the data</div></td>
  </tr>
  <tr class="tabletitle2">
    ...
    <td width="64%"><div align="left">
     <form action="month_selected.php" method="post">
      <select name="month">
      	<?php
