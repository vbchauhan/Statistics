...
<table width="50%" border="0" cellspacing="1" cellpadding="1" align="center" style="margin-top:10px; margin-bottom:20px; background-color:#FFF">
  <tr bgcolor="#990000" >
    <td height="52" colspan="3"><div align="center" class="tabletitle">Select the date to enter the data</div></td>
  </tr>
  <tr class="tabletitle2">
    ...
    <td width="64%"><div align="left">
     ...
     <form name="enter_daily_data" action="validate_date.php" method="post">
      <select name="month">
      	<?php
