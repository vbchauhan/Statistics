...
--
-- Host: localhost    Database: priyasga_lib_rsrc_mgmt
-- ------------------------------------------------------
...
--
-- Current Database: `priyasga_lib_rsrc_mgmt`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `priyasga_lib_rsrc_mgmt` /*!40100 DEFAULT CHARACTER SET latin1 */;

USE `priyasga_lib_rsrc_mgmt`;
