...
<title>View graph for Yearly data over Years</title>
</head>
...
<table width="60%" border="0" cellspacing="1" cellpadding="1" align="center" style="margin-top:10px; margin-bottom:20px; background-color:#FFF">
  <tr bgcolor="#990000" >
    <td height="52" colspan="3"><div align="center" class="tabletitle">Select the years to view the data</div></td>
  </tr>
  <tr class="tabletitle2">
    <td width="21%" height="49" style="padding-top:3px; padding-bottom:3px; padding-right:5px"><div align="center"><img src="images/Calendar.png" width="87" height="81" align="right"/></div></td>
    <td width="79%"><div align="left">
     <form action="validate_years.php" method="GET" target="_blank">
      Parameter&nbsp;:
