...
<table width="50%" border="0" cellspacing="1" cellpadding="1" align="center" style="margin-top:10px; margin-bottom:20px; background-color:#FFF">
  ...
  <tr class="tabletitle2">
    <td width="27%" height="49" style="padding-top:3px; padding-bottom:3px; padding-right:5px"><div align="center"><img src="images/Calendar.png" width="87" height="81" align="center"/></div></td>
    <td width="73%" align="right"><div align="left">
     <form action="validate_between_date.php" method="get">
     From:
      <select name="month1">
      	<?php
